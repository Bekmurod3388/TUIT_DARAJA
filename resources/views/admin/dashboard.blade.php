...
<div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white shadow-lg flex flex-col items-center py-8">
        ...
        <nav class="w-full px-6">
            <ul class="space-y-2">
                <li>
                    <a href="/admin" class="flex items-center px-4 py-2 rounded-lg bg-blue-100 text-blue-700 font-semibold">
                ...
                <li>
                    <a href="/admin/users" class="flex items-center px-4 py-2 rounded-lg hover:bg-gray-100 text-gray-700">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
