...
@section('title', 'Dastur tahrirlash')
@section('content')
<div class="bg-white rounded-xl shadow p-8 max-w-lg mx-auto">
    ...
    <form method="POST" action="{{ route('admin.programs.update', $program->id) }}">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="program-code" class="w-full border rounded px-3 py-2 bg-gray-100" readonly value="{{ $program->code }}">
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="number" name="price" class="w-full border rounded px-3 py-2" min="0" required value="{{ old('price', $program->price) }}">
        </div>
        <div class="mb-4">
